...
namespace AvioMicroservice.FlightRepositories
{
    public class FlightReservationRepo : IFlightReservation
    {
        ...
        public async Task<ActionResult<IEnumerable<FlightReservation>>> GetFlightReservations(MAANPP20ContextFlight _context, string idUser)
        {
        ...
        private bool FlightReservationExists(MAANPP20ContextFlight _context, int id) => _context.FlightReservations.Any(e => e.id == id);
        ...
        public async Task<ActionResult<IEnumerable<FriendForFlight>>> GetCallsForFlight(MAANPP20ContextFlight _context, string email)
        {
        ...
        public async Task<ActionResult<IEnumerable<FlightReservation>>> GetFlightReservationsStatistics(MAANPP20ContextFlight _context, int idFlight)
        {
            return await _context.FlightReservations
                .Where(x => x.deleted == false)
