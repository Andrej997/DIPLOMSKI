...
namespace UserMicroservice.Controllers
{
    ...
    {
        private readonly MAANPP20ContextUser _context;
        private readonly ApplicationSettings _applicationSettings;
        private static Random random;

        public MyUserController(IOptions<ApplicationSettings> applicationSettings, MAANPP20ContextUser context)
        {
            _context = context;
        ...
        public async Task<Object> PostRegisterUser(UserModel model)
        {
            ...
            var user = new User()
            {
                ...
                Email = "andrej.km997@gmail.com",//model.Email,
            ...
            try
            {
                ...
                user.activationCode = "1234";//randNumber.ToString();
